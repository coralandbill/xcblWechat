    ...
    <div class="new_list new_list1 t10">
        <ul id="newsUl">
            <script type="text/x-jquery-tmpl" id="newInfoTmpl">
                <li class="clearfix"><a target="_blank" href="#[$data.fileCompanyUrl]">#[$data.fileName]</a></li>
...
<script type="text/javascript">
    ...
    function loadNewsInfo() {
        $.ajax({
            url: "/wechat/companyAjax/fileList.do",
            ...
            success: function (result) {
                if (result.success) {
                    ...
                    $("#newInfoTmpl").tmpl(fileList).insertBefore("#news_p");
                    $("#loadingWeUi").hide();
                }
            }
        });
